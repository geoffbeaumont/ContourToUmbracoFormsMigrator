...
namespace Umbraco.Forms.Migration.DataLayer.Extensions
{
    /// <summary>
    ...
    public class SqlHelperExtender : ISqlHelper
    {
        ...
        /// <exception cref="Umbraco.Forms.Migration.DataLayer.SqlHelperException">If a data source error occurs.</exception>
